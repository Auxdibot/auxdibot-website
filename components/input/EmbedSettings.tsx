...
import { BsImage, BsListTask, BsPencil, BsPerson, BsPlus, BsTextCenter, BsTextLeft, BsTextarea, BsX } from "react-icons/bs";
...
export default function EmbedSettings({ value, register, setValue, addField, removeField }: EmbedSettingsProps) {
    ...
    return (<div>
        ...
        <label ref={colorRef} className={"flex flex-row max-md:mx-auto gap-2 items-center font-lato text-xl"}>
