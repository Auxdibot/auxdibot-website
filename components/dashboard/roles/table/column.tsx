...
export const columns: (serverID: string) => ColumnDef<{
        ...
        cell: ({ row }) => {
            return (
                <span className={'flex items-center gap-2'}>
                    {row.original.reactions.map(
                        (i: { emoji: string }, index) => {
                            return (
                                <Twemoji serverID={serverID} key={index}>
                                    {i.emoji}
                                </Twemoji>
                            );
                        }
            ...
            function RowActions() {
                ...
                function deleteReactionRole() {
                    ...
                    fetch(`/bot/v1/servers/${serverID}/reaction_roles`, {
                        ...
                        if (!json || json['error']) {
                            toast({
                                title: 'Failed to delete reaction role',
                                description:
                        ...
                        toast({
                            ...
                            description: `Reaction Role #${row.original.index + 1} was deleted.`,
                            status: 'success',
                        });
                    });
                }
