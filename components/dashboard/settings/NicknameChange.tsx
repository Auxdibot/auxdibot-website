...
export default function NicknameChange({ server }: { server: DiscordGuild & { data: {serverID: string, disabled_modules: string[]} } }) {
    ...
    <span className={"flex flex-col gap-2 w-fit mx-auto items-center"}><input value={nick} onChange={(e) => onNickChange(e)} maxLength={32} className={"font-roboto rounded-md p-0 text-md"}/> 
