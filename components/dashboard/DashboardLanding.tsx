...
export default function DashboardLanding() {
    return (<main className={'flex-grow flex bg-gray-700 justify-center items-center'}>
        <div className={"animate-fadeIn max-w-xl flex flex-col gap-4"}>
            <h1 className={"header text-6xl text-center max-md:text-5xl"}>Auxdibot Dashboard</h1>
