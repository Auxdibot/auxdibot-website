...
import DisabledModules from "./settings/DisabledModules";
import AuxdibotSettings from "./settings/AuxdibotSettings";
...
export default function DashboardSettingsConfig({ serverID }: { serverID: string }) {
    ...
    return (<main className={"bg-gray-700 flex-grow"}>
        ...
        <span className={"grid grid-cols-3 max-xl:grid-cols-2 max-lg:grid-cols-1 grid-rows-3 grid-flow-row gap-5"}>
