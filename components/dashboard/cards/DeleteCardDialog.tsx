...
export function ResetDialog({ serverID }: { serverID: string }) {
    ...
    function reset() {
        fetch(`/bot/v1/servers/${serverID}/updateCard`, { method: 'DELETE' })
            .then(() => {
    ...
    return (
        <AlertDialog>
            <AlertDialogTrigger asChild>
                <Button
                    className={
                        'mx-auto flex w-fit items-center gap-2 font-open-sans'
                    }
                    variant={'destructive'}
                    type='submit'
                >
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        Are you sure you want to reset Auxdibot&apos;s Card
                        settings for this server? This action is{' '}
                        <span className={'text-red-500'}>irreversible</span> and
                        will delete all your card data.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
