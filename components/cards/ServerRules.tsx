...
export default function ServerRules({ data }: { readonly data: CardData; }) {
    ...
    <section className={`${data?.dark ? "bg-black" : "bg-gray-100"} ${data?.dark ? "text-gray-100" : "text-gray-900"} ${data?.dark ? "border-gray-800" : "border-gray-300"} w-full text-lg border px-3 py-10 bg-opacity-60 rounded-2xl flex-1`}>
