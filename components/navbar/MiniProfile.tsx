...
export default function MiniProfile(props: React.ComponentProps<any>) {
    ...
    return (<div ref={ref} {...props}>
        ...
        <div className={`absolute ${expanded ? "scale-100" : "scale-0"} transition-all origin-top select-none top-14 z-10 max-md:-translate-x-8 bg-gray-500 border border-gray-500 rounded-xl`}>
