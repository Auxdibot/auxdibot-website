...
>(({ className, ...props }, ref) => (
    <ToastPrimitives.Viewport
        ref={ref}
        className={cn(
            'pointer-events-none fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 max-md:bottom-0 max-md:left-0 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]',
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <ToastPrimitives.Title
        ref={ref}
        className={cn('font-montserrat text-base [&+div]:text-xs', className)}
        {...props}
    />
));
...
>(({ className, ...props }, ref) => (
    <ToastPrimitives.Description
        ref={ref}
        className={cn('font-open-sans text-sm opacity-90', className)}
        {...props}
    />
));
