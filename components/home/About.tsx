...
export default function About() {
    ...
    return (
        <section className={"w-full flex flex-col bg-gradient-to-b from-black to-background-300 gap-40"}>
        ...
        <section className={"flex flex-col pt-10 gap-40"}>
        ...
        <motion.p initial={{ transform: "translateX(4rem)", opacity: 0 }} viewport={{ once: true }} whileInView={{ transform: "translateY(0px)", opacity: 1 }} transition={{ duration: 0.5 }} className={'font-open-sans text-gray-400 text-2xl max-md:text-center'}>Auxdibot is a Discord bot project founded and maintained by <Link href={"https://auxdible.me"} className={"header font-montserrat font-bold"}>Auxdible</Link>. Auxdibot features a wide variety of features for admins to manage their servers with. Auxdibot receives consistant updates and constant bug fixes, making it a reliable choice for your server!</motion.p>
        </section>
        <Points/>
        </section>
        <Start/>
