...
export default function Start() {
    return (<section className={"flex flex-col max-w-6xl mx-auto"}>
        ...
        <section className={"flex flex-col items-center flex-1 gap-4 font-open-sans text-xl text-gray-300 text-center px-2"}>
            ...
            <motion.div initial={{ scale: 0, rotate: '45deg' }} viewport={{ once: true }} whileInView={{ scale: 1, rotate: '45deg' }} transition={{ duration: 0.5 }} className={'origin-top border border-white h-8 rotate-12 w-0 mx-auto mt-2'}></motion.div>
