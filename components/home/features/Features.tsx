        ...
        <section className="bg-zinc bg-opacity-50 py-5">
            ...
            <div className="grid grid-cols-3 max-lg:grid-cols-2 max-sm:grid-cols-1 max-lg:px-5 max-sm:flex max-sm:flex-col gap-4 max-w-7xl mx-auto">
                <div className="flex flex-col bg-gradient-to-bl from-zinc-300/5 to-zinc-900/5 cursor-pointer hover:bg-zinc-500/5 transition-colors border-2 border-zinc-800 p-4 rounded-lg shadow">
                    <h2 className="font-raleway text-zinc-200 font-bold text-2xl flex gap-2 items-center"><ShieldAlert/> <span className="flex items-center">Moderation <Link href={process.env.NEXT_PUBLIC_DOCUMENTATION_LINK + "/modules/moderation"}><Button className="text-sm" variant="link">[docs]</Button></Link></span></h2>
                ...
                <div className="flex flex-col bg-gradient-to-bl from-zinc-300/5 to-zinc-900/5 cursor-pointer hover:bg-zinc-500/5 transition-colors border-2 border-zinc-800 p-4 rounded-lg shadow">
                    <h2 className="font-raleway text-zinc-200 font-bold text-2xl flex gap-2 items-center"><MessageCircle/> <span className="flex items-center">Embeds <Link href={process.env.NEXT_PUBLIC_DOCUMENTATION_LINK + "/modules/embeds"}><Button className="text-sm" variant="link">[docs]</Button></Link></span></h2>
                ...
                <div className="flex flex-col bg-gradient-to-bl from-zinc-300/5 to-zinc-900/5 cursor-pointer hover:bg-zinc-500/5 transition-colors border-2 border-zinc-800 p-4 rounded-lg shadow">
                    <h2 className="font-raleway text-zinc-200 font-bold text-2xl flex gap-2 items-center"><Tag/> <span className="flex items-center">Roles <Link href={process.env.NEXT_PUBLIC_DOCUMENTATION_LINK + "/modules/roles"}><Button className="text-sm" variant="link">[docs]</Button></Link></span></h2>
                ...
                <div className="flex flex-col bg-gradient-to-bl from-zinc-300/5 to-zinc-900/5 cursor-pointer hover:bg-zinc-500/5 transition-colors border-2 border-zinc-800 p-4 rounded-lg shadow">
                    <h2 className="font-raleway text-zinc-200 font-bold text-2xl flex gap-2 items-center"><BellRing/> <span className="flex items-center">Notifications <Link href={process.env.NEXT_PUBLIC_DOCUMENTATION_LINK + "/modules/notifications"}><Button className="text-sm" variant="link">[docs]</Button></Link></span></h2>
                ...
                <div className="flex flex-col bg-gradient-to-bl from-zinc-300/5 to-zinc-900/5 cursor-pointer hover:bg-zinc-500/5 transition-colors border-2 border-zinc-800 p-4 rounded-lg shadow">
                    <h2 className="font-raleway text-zinc-200 font-bold text-2xl flex gap-2 items-center"><Handshake/> <span className="flex items-center">Suggestions <Link href={process.env.NEXT_PUBLIC_DOCUMENTATION_LINK + "/modules/suggestions"}><Button className="text-sm" variant="link">[docs]</Button></Link></span></h2>
                ...
                <div className="flex flex-col bg-gradient-to-bl from-zinc-300/5 to-zinc-900/5 cursor-pointer hover:bg-zinc-500/5 transition-colors border-2 border-zinc-800 p-4 rounded-lg shadow">
                    <h2 className="font-raleway text-zinc-200 font-bold text-2xl flex gap-2 items-center"><Star/> <span className="flex items-center">Starboard <Link href={process.env.NEXT_PUBLIC_DOCUMENTATION_LINK + "/modules/starboard"}><Button className="text-sm" variant="link">[docs]</Button></Link></span></h2>
                ...
                <div className="flex flex-col bg-gradient-to-bl from-zinc-300/5 to-zinc-900/5 cursor-pointer hover:bg-zinc-500/5 transition-colors border-2 border-zinc-800 p-4 rounded-lg shadow">
                    <h2 className="font-raleway text-zinc-200 font-bold text-2xl flex gap-2 items-center"><Clock/> <span className="flex items-center">Schedules <Link href={process.env.NEXT_PUBLIC_DOCUMENTATION_LINK + "/modules/schedules"}><Button className="text-sm" variant="link">[docs]</Button></Link></span></h2>
                ...
                <div className="flex flex-col bg-gradient-to-bl from-zinc-300/5 to-zinc-900/5 cursor-pointer hover:bg-zinc-500/5 transition-colors border-2 border-zinc-800 p-4 rounded-lg shadow">
                    <h2 className="font-raleway text-zinc-200 font-bold text-2xl flex gap-2 items-center"><Hand/> <span className="flex items-center">Greetings <Link href={process.env.NEXT_PUBLIC_DOCUMENTATION_LINK + "/modules/greetings"}><Button className="text-sm" variant="link">[docs]</Button></Link></span></h2>
                ...
                <div className="flex flex-col bg-gradient-to-bl from-zinc-300/5 to-zinc-900/5 cursor-pointer hover:bg-zinc-500/5 transition-colors border-2 border-zinc-800 p-4 rounded-lg shadow">
                    <h2 className="font-raleway text-zinc-200 font-bold text-2xl flex gap-2 items-center"><Scroll/> <span className="flex items-center">Logging <Link href={process.env.NEXT_PUBLIC_DOCUMENTATION_LINK + "/modules/logging"}><Button className="text-sm" variant="link">[docs]</Button></Link></span></h2>
                ...
                <div className="flex flex-col bg-gradient-to-bl from-zinc-300/5 to-zinc-900/5 cursor-pointer hover:bg-zinc-500/5 transition-colors border-2 border-zinc-800 p-4 rounded-lg shadow">
                    ...
                    <h2 className="font-raleway text-zinc-200 font-bold text-2xl flex gap-2 items-center"><Image/> <span className="flex items-center">Cards <Link href={process.env.NEXT_PUBLIC_DOCUMENTATION_LINK + "/navigating/dashboard"}><Button className="text-sm" variant="link">[docs]</Button></Link></span></h2>
