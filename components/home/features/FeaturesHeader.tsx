...
export function FeaturesHeader() {
    return (<div className='flex flex-col my-5 items-center gap-2 justify-center'>
        ...
        <motion.span initial={{ transform: "translateY(-4rem)", opacity: 0 }} viewport={{ once: true }} whileInView={{ transform: "translateY(0px)", opacity: 1 }} transition={{ duration: 0.5, delay: 0.75 }} className='font-inter text-xl text-zinc-300'>
