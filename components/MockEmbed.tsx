...
export default function MockEmbed({ embed }: { embed: APIEmbed }) {
    ...
    return (<div className={`font-sans bg-discord-embed rounded-l-md overflow-hidden rounded-r-md flex flex-col pl-4 py-3 relative pr-5 max-sm:max-w-[95vw] sm:max-w-[512px]`}>
