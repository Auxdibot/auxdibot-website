...
export function PremiumBenefits() {
    return (
        <>
            ...
            <li className={'flex items-center gap-1 font-open-sans'}>
                <BsCheck className={'flex-shrink-0 text-2xl'} /> Special user
                badge for your servers & profile on Auxdibot.
            </li>
            <li className={'flex items-center gap-1 font-open-sans'}>
                <BsCheck className={'flex-shrink-0 text-2xl'} /> Higher priority
                on Server Discovery (SOON)
            </li>
            <li className={'flex items-center gap-1 font-open-sans'}>
            ...
            <li className={'flex items-center gap-1 font-open-sans'}>
                <BsCheck className={'flex-shrink-0 text-2xl'} /> Supporting the
                future of Auxdibot.
            </li>
        </>
    );
