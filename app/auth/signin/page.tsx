...
export default function SignIn() {
    ...
    <main className={"flex justify-center flex-col items-center gap-5 bg-gray-700 flex-grow"}>
        ...
        <h1 className={"header text-6xl"}>Sign In</h1>
        <p className={"secondary text-2xl"}>Sign in to use Auxdibot&apos;s dashboard!</p>
        <div className={"bg-gray-800 bg-opacity-50 p-4 rounded-2xl"}><button onClick={() => signIn('discord')} className={"flex flex-row gap-2 items-center p-2 font-roboto text-xl rounded-xl bg-discord-primary border-2 border-gray-500 border-opacity-30 text-white"}><BsDiscord/> Sign in with Discord</button></div>
    </main>)
}