            ...
            <section className='my-20 flex w-full flex-col gap-20'>
                ...
                >
                    <div>
                        ...
                        <span className='font-inter text-lg text-zinc-400'>
                            We all love roles and fancy icons.
                        </span>
                    </div>

                    <p className={'max-w-lg font-inter text-zinc-200'}>
                        Users who donate to Auxdibot can recieve an exclusive
                        role on Auxdibot&apos;s Discord server, as well as a
                        badge their premium servers.
                    </p>
                </article>
            </section>
            <section
